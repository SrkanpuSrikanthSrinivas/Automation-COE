  ...
  return [
    {
      ...
      body: "Share something you learned on a real project: a tutorial, a post-mortem, or a framework comparison. Write it in the form with a live preview, or edit the file directly if you prefer Git.",
      folder: "content/blog",
    ...
    },
    {
      ...
      body: "Showcase an open-source tool you maintain. It gets its own product page, listed under one of: Web automation, Mobile automation, AI for testing, Developer productivity.",
    ...
    },
    {
      ...
      body: "Say who you are, what you work on, and how others can work with you: mentoring, pairing, speaking, reviewing, or co-authoring. Your handle becomes your profile address.",
    ...
    },
    {
      ...
      body: "Put a piece of work on the board so others can pick it up with you. Say what is needed, who leads it, and whether it takes a few hours, a few days, or is ongoing.",
